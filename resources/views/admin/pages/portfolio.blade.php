...
<div class="card">
    <div class="card-header border-bottom">
        <h4 class="card-title">Portfolio Skills</h4>
    </div>
    <div class="card-body">
        <!-- form -->
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="mt-2 pt-50" id="update-coding-skill-form" method="POST"
                    action="{{ route('admin.coding-skill.update') }}">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 text-center">
                            <button class="btn btn-success w-50" type="button" id="update_coding_skill_btn"
                                onclick="_run(this)" data-el="fg" data-form="update-coding-skill-form"
                                data-callback="updateCodingSkillCallback" data-btnid="update_coding_skill_btn">
